...
const NavItem: React.FC<NavItemProps> = ({ icon, label, isActive, onClick }) => (
  <li>
    ...
    >
      {/* FIX: Replaced React.cloneElement with a simple wrapper div to fix the TypeScript error. This applies the necessary classes to a container around the icon, which is a type-safe and effective solution. */}
